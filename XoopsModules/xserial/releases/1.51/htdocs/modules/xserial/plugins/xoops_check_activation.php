<?php
include(XOOPS_ROOT_PATH.'/modules/xserial/plugins/inc/usercheck.php');
	include(XOOPS_ROOT_PATH.'/modules/xserial/plugins/inc/authcheck.php');
	include(XOOPS_ROOT_PATH.'/modules/xserial/plugins/inc/siteinfocheck.php');
